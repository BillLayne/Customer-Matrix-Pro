...
const PROGRAMS: ProgramEntry[] = [
  ...
  },
  {
    ...
    category: 'Documents & Forms',
    description: 'Open the DL123 maker for North Carolina driver license liability insurance certifications.',
    target: 'C:\\Users\\bill\\OneDrive\\Documents\\Playground\\dl123-generator\\index.html',
    hostedTarget: '/dl123-generator/index.html',
    icon: 'fa-solid fa-file-shield',
    accent: 'from-blue-900 to-cyan-500',
    note: 'Local + hosted tool',
    targetType: 'local',
  },
  {
